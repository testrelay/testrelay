                        ...
                        <div>
                            <div className="flex flex-col items-center justify-center w-full h-full text-center ">
                                ...
                                <div className="w-full mt-5 sm:mt-12 sm:flex items-center justify-center">
                                    <a className="block mx-auto w-3/4 sm:w-auto  shadow-md px-4 py-3 text-base font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700"
                    ...
                    <div className="bg-gray-100 shadow-inner">
                        <div className="container max-w-screen-xl mx-auto">
                            <div className="py-16 px-4 sm:px-8 text-center">
                                ...
                                <p className="mt-2">TestRelay takes care of <span
                                    className="text-indigo-500">scheduling</span>, <span
                                    className="text-indigo-500">creating</span> and <span
                                    className="text-indigo-500">running</span> your take home assignments.</p>
                                <div className="">
                                    <div
                                        ...
                                        <div className="flex justify-center items-center">
                                            ...
                                            <p className="ml-3 leading-2 text-gray-600 text-left md:text-center">
                                                Auto generate private repos for candidates
                                            </p>
                                        </div>
