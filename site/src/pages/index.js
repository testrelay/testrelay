    ...
    <div>
          ...
          <div className="flex justify-between flex- content-center items-center py-2">
            ...
            <div className="hidden md:block">
              <ul className="flex flex-">
                <li className="">
                  <a className="flex items-center justify-center px-4 py-3 text-base font-medium rounded-md hover:text-gray-500" href="//app.testrelay.io/login">Login</a>
                </li>
                <li className="px-2">
                  <a className="shadow-md flex items-center justify-center px-4 py-3 text-base font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700" href="//app.testrelay.io/register">Signup for free</a>
                </li>
              </ul>
            </div>
            ...
            <div className="navbar mobile-nav px-0 mx-0 hidden md:hidden fixed top-0 left-0 w-full bg-white h-screen fixed z-50 p-3">
              ...
              <ul className="flex flex-col text-center mt-2 pt-2 w-full">
                ...
                <li className="w-full">
                  <a className="w-full text-lg border-t border-gray-200 block py-3" href="//app.testrelay.io/login">Login</a>
                </li>
            ...
            <div>
              <div className="flex flex-col items-center justify-center w-full h-full text-center ">
                ...
                <h2 className="mt-5 text-lg text-gray-600 sm:mt-8 sm:max-w-2xl sm:mx-auto md:mt-8 md:text-xl lg:mx-0">
                  TestRelay takes care of <span className="text-indigo-500">scheduling</span>, <span className="text-indigo-500">creating</span> and <span className="text-indigo-500">running</span> your take home assignments. Add your candidates and let TestRelay handle the rest.
                </h2>
                <div className="w-full mt-5 sm:mt-12 sm:flex items-center justify-center">
                  <a className="shadow-md flex items-center justify-center px-4 py-3 text-base font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700" href="//app.testrelay.io/register">
                ...
                <div className="mt-4 w-full">
                  <div className="max-w-3xl mx-auto my-10 shadow-md rounded-b-lg">
                    ...
                    <div className="bg-gray-100 border-t-0 w-full  rounded-b-lg flex overflow-hidden" style={{ height: "28rem" }}>
                      <div class="pl-4 md:pl-14 text-left">
          ...
          <div className="bg-gray-100 shadow-inner">
            <div className="container max-w-screen-xl mx-auto">
              <div className="py-16 px-8 text-center">
                <svg className="h-20 w-20 mx-auto text-gray-800 group-hover:text-gray-200 mb-4" viewBox="0 0 256 250" version="1.1" preserveAspectRatio="xMidYMid">
                  <g>
                ...
                <h2 className="font-bold text-4xl">A robust interviewing strategy built on Github</h2>
                <p className="mt-2">Testrelay is an <span className="text-indigo-500">all-in-one</span> tool for managing your technical interviews through Github.</p>
                <div className="">
                  <div className="mt-8 font-medium md:flex md:justify-center md:items-center space-y-3 md:space-y-0 md:space-x-5 md:flex-row">
                    <div className="flex justify-center items-center">
                      ...
                      <p className="ml-3 leading-2 text-gray-600 text-left md:text-center">
                        Author your tests using github
                      </p>
                    </div>
                    <div className="flex justify-center items-center">
                      <div className="flex-shrink-0">
                      ...
                      <p className="ml-3 leading-2 text-gray-600 text-left md:text-center">
                        Auto generate private repos for assignments
                      </p>
                    </div>
              ...
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div className="ml-auto lg:ml-6 lg:col-start-2 lg:max-w-2xl">
                  ...
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    Store your organisation's technical tests directly on github.  Build your technical tests like you would applications.
                  </p>

                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    TestRelay automatically keeps up to date with the latest changes. Candidates always get the most recent version.
                  </p>
                </div>
                <div className="relative mt-10 lg:-mx-4 relative-20 sm:mt-0 lg:col-start-1">
                  <div className="bg-gray-50 relative p-8 w-100 h-auto rounded">
                    <div className="bg-white p-2 mb-8 overflow-hidden rounded shadow">
                      <img src={Changelog} />
                    </div>

                    <div className="bg-white w-1/2 right-4 bottom-4 p-4 rounded shadow absolute">
                      <label className="block text-gray-700 text-xs font-bold mb-2">Choose Candidate's Technical Assignment</label>
                      <div className="w-full">
                        <p className="mb-2 text-xs"> TestRelay will clone this repository to the candidate's technical test.</p>
                        <div className="relative">
                          <div className="bg-gray-100  rounded p-4 border"></div>
                          <div className="grid text-xs divide-y shadow rounded absolute w-full bg-white top-2 left-2">
                            <div className="p-2 cursor-pointer">acme/be-eng-test</div>
                            <div className="p-2 cursor-pointer text-white bg-indigo-500">acme/ds-interview
                              <img className="w-4 h-6 absolute z-10 right-6" src={Cursor} />
                            </div>
            ...
            <div className="relative">
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div className="ml-auto lg:mr-6 lg:col-start-1 lg:max-w-2xl">
                  ...
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    Let TestRelay handle scheduling and running a candidate's technical test. Candidates receive a dedicated portal to schedule tests when it suits them.
                  </p>

                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    TestRelay automatically keeps on top of candidates technical assignments, managing access for candidates when needed. Never worry about sending technical tests on your days off.
                  </p>
                </div>
                    ...
                    <div className="bg-gray-50 relative p-8 w-100 h-auto rounded">
                      <div>
                        <div className="bg-white mb-2 p-2 overflow-hidden rounded shadow">
                          <div className="relative bg-white p-2 rounded text-center md:text-left">
                            <div className="grid grid-cols-3 gap-4">
                              ...
                              <div>
                                <div>
                                  <div className="text-xs mb-1 font-medium text-gray-900">
                                    8th March 2021
                                  </div>
                          ...
                          <div className="relative bg-white p-2 rounded text-center md:text-left">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="text-right">
                                <div>
                                  <div className="text-xs mb-1 font-medium text-green-600">
                                    Completed
                                  </div>
                                  <div className="text-xs text-gray-500">
                        ...
                        <div className="absolute bg-gray-50  opacity-30 w-full h-full right-0 top-0 bottom-0"></div>
                        <div className="bg-white w-1/2 left-0 right-0 top-20 mx-auto p-4 pb-10 rounded shadow-xl border  absolute">
                          <label className="block text-gray-700 text-xs font-bold mb-2">Nipo Inc has invited you to a technical test</label>
                          <div className="w-full h-auto relative">
                            <p className="text-xs mb-2">Schedule a date & time for your assignment.</p>
                            <div className="px-2 py-2 text-xs border bg-gray-50 text-gray-800 flex rounded items-center mb-2">
                            ...
                            <div className="shadow-xl border p-2 bg-white absolute z-10 rounded w-2/3">
            ...
            <div className="relative">
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div className="ml-auto lg:ml-6 lg:col-start-2 lg:max-w-2xl">
                  ...
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    TestRelay auto generates private repositories that candidates will use to sit their technical test.
                  </p>
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    Once a candidate finishes their assignment they're removed access to the repository.
                  </p>
                </div>
                <div className="relative mt-10 relative-20 lg:mt-0 lg:col-start-1">
                  <div className="bg-gray-50 p-8 rounded">
                    <img className="mx-auto py-4 w-20" src="https://ci3.googleusercontent.com/proxy/UFMFbT0UrmdnumWhFvGkEviupuQf7QIzl3VYfzne8CB_LgHu7d0dAbUn5An4x3f8ySn_6KomW968hn2Z6wR3gk3e3r0L-r8TYF530A4AASxTI0c=s0-d-e1-ft#https://github.githubassets.com/images/email/global/wordmark.png" />
                    <div className="bg-white border rounded p-4 w-5/6 mx-auto">
                      <div className="py-2 grid grid-cols-3 mx-auto w-1/3">
                        <div className="flex items-center text-center">
                          <img className="mx-auto w-10 h-10" src="https://avatars.githubusercontent.com/u/90466910?s=120" alt="@testrelay" />
                        </div>
                        <div className="flex items-center text-center">
                          <img className="mx-auto w-10 h-10" alt="plus" src="https://github.githubassets.com/images/email/organization/octicon-plus.png" />
                        </div>
                        <div className="flex items-center text-center">
                          <img className="mx-auto w-10 h-10" src="https://avatars.githubusercontent.com/u/6455139?s=120" alt="@hugorut" />
                        </div>
                      </div>
                      <div>
                        <p className="text-center text-sm mt-2 mb-4">@testrelay has invited you to collaborate on the<br /><span className="font-bold">testrelay/hugorut-nipo-inc-test-hyly</span> repository</p>
                      </div>
                      <div className="border-b mb-2"></div>
                      <div>
                        <p className="text-xs mb-4">You can <span className="text-blue-500">accept or decline</span> this invitation. You can also visit <span className="text-blue-500">@testrelay</span> to learn a bit more about them.</p>
                        <p className="text-xs">This invitation will expire in 7 days.</p>
                        <div className="cursor-pointer bg-gradient-to-b  font-bold from-green-400 to-green-600 text-center w-32  mx-auto text-xs rounded px-4 py-2 mt-6 text-white">View Invitation</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative">
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div className="ml-auto lg:mr-6 lg:max-w-2xl">
                  ...
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    Import colleagues into TestRelay and seamlessly manage which assignments they need to review.
                  </p>
                  <p className="mt-4 text-lg leading-6 text-gray-600">
                    Completed technical assignments are opened as PRs on Github. TestRelay auto requests a code review from your nominated interviewers.
                  </p>

                </div>
                <div className="relative mt-10 space-y-6 relative-20 lg:mt-0">
                  <div className="bg-gray-50 relative p-8 w-100 h-auto rounded">
                    <div className="bg-white p-2 overflow-hidden rounded shadow">
                      <img src={Review} />
                    </div>
                  </div>
                </div>
            ...
            <section className="text-gray-600 body-font overflow-hidden">
              <div className="container px-5 py-8 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                  ...
                  <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-600">We're committed to having a free plan, forever. Only pay for features when you can afford to do so.</p>
                </div>
                <div className="flex flex-wrap justify-center -m-4">
                  <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div className="h-full p-6 rounded-lg bg-white  border-2 border-indigo-500 shadow-md flex flex-col relative overflow-hidden">
                      ...
                      <a href="//app.testrelay.com/register" className="flex items-center mt-auto text-white bg-indigo-500 bborder-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">Get Started
                  ...
                  <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div className="h-full p-6 rounded-lg  bg-white shadow-md flex flex-col relative overflow-hidden">
                      <span className="bg-gray-300 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">coming when it's ready</span>
                      ...
                      <p className="flex items-center text-gray-600 mb-2">
                        We're focused on building a product that people will love. All plans are free for now and we will always have a free tier.
                      </p>
      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 TestRelay</p>
        </div>
      </footer>
    </div>
  )
