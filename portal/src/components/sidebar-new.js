    ...
    if (data.businesses.length === 1) {
        ...
        return (
            <div className="flex justify-center space-x-1 items-center">
                {name}
                <Link to="/business/create" className="hover:bg-indigo-500 bg-indigo-600 text-white text-sm rounded px-4 py-2 w-auto">Create Org</Link>
            </div>
        )
    }
            ...
            <div className="drawer-content">
                <div className="flex mx-auto px-6 pt-4 justify-end container lg:hidden">
                    <label htmlFor="my-drawer-2" className="drawer-button block">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gray-800 cursor-pointer hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="drawer-side gap-1 shadow-xl">
                ...
                <div  className="menu py-4 overflow-y-auto w-80 text-base-content bg-white">
                    ...
                    <div className="px-4 mt-12 items-end flex">
                        <button className="flex justify-center items-center hover:bg-indigo-500 bg-indigo-600 text-white text-sm lg:text-xs rounded px-4 py-2 w-auto" onClick={revoke}>
                            <span className="ml-2 mr-1">Logout</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 lg:h-4 lg:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
