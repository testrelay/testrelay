        ...
        return (
            <div className="border-4 border-gray-200 border-dashed p-8 rounded flex justify-center items-center">
                <div className="max-w-md text-center justify-center">
                    ...
                    <p className="text-md mb-4">You'll need to link your account to github before seeing your assigned reviews. This is so we can invite you as a collaborator to candidates' test repositories.</p>
