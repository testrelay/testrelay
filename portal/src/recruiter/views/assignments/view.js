    ...
    return (
        <div>
            ...
            <div className="flex flex-row">
                <div className="w-2/3">
                    <Timeline id={id} events={data.assignments_by_pk.assignment_events}
                              test={data.assignments_by_pk.test}/>
                </div>
            </div>
        </div>
    );
    ...
    const formatted = users.map((r) => {
        let g = (
            <span className="text-md text-red-300 flex items-center">
				<svg className="h-4 w-4 text-red-300" width="20px" height="20px" viewBox="0 0 256 250" version="1.1"
        ...
        if (r.user.github_username) {
            g = (
                <span className="text-md text-gray-300 flex items-center">
					<svg className="h-4 w-4 text-gray-300" width="20px" height="20px" viewBox="0 0 256 250"
            ...
            <div key={r.user.id}>
                <div className="flex">
                    ...
                    <div>
                        ...
                        }} className="h-6 w-6 text-gray-600 hover:text-indigo-500 cursor-pointer" fill="none"
